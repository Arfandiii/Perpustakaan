<div
    class="hover:cursor-pointer hover:ml-4 w-full text-white hover:text-indigo-600 bg-gray-800 p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
    @switch($iconType)
    @case('dashboard')
