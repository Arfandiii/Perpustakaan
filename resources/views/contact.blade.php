...
@section('content')
<div class="relative isolate overflow-hidden bg-gray-800 py-8 sm:py-12 w-screen">
    ...
    <div class="px-6 font-medium my-16">
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <div class="p-3 mb-4 text-sm text-green-700 bg-green-100 rounded-lg text-left" role="alert">
                <p>{{ session('success')}}</p>
            </div>
            @endif
            <h2 class="text-balance text-4xl font-semibold tracking-tight text-gray-200 sm:text-5xl">Hubungi Kami
            </h2>
            <p class="mt-2 text-lg/8 text-gray-100">Kami senang mendengar dari Anda! Jika Anda memiliki pertanyaan,
                saran, atau membutuhkan bantuan, jangan ragu untuk
                menghubungi kami.
            </p>
        </div>
        <form action="{{ route('contact.send') }}" method="POST" class="mx-auto mt-8 max-w-xl">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <label for="message" class="block text-sm/6 font-semibold text-white">Pesan</label>
                    <div class="mt-2.5">
